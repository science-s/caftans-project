...
public class RecommendedCaftanAdapter extends RecyclerView.Adapter<RecommendedCaftanAdapter.ViewHolder> {
    ...
    public RecommendedCaftanAdapter(List<Caftan> caftans, OnCaftanClickListener listener) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_caftan_recommended, parent, false);
